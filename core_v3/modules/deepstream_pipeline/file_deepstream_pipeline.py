...
class FileDeepstreamPipeline(DeepstreamPipelineInterface):
    ...
    def __init__(
        ...
        self._preview_style_hold_seconds = 3
    ...
    def _osd_probe(self, pad, info, user_data):
        ...
        while l_frame:
            ...
            for person in persons:
                ...
                attr_labels = [
                    self.class_id_to_label.get(a["class_id"], str(a["class_id"]))
    ...
    def _cleanup_preview_style_cache(self, active_track_ids):
        ...
        for track_id in list(self._person_preview_style_cache.keys()):
            ...
            if track_id not in active_track_ids and (now - cached["last_seen_at"]) > self._preview_style_hold_seconds:
    ...
    def _apply_person_preview(self, batch_meta, frame_meta, obj, frame_w, frame_h, safe_offset, style):
        ...
        location_text = self.frame_drawer.location_name or "Unknown"
