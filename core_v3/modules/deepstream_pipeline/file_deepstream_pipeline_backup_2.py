        ...
        while l_frame:
            ...
            while l_obj:
                ...
                if obj.class_id == 0:
                    ...
                    texts[0].display_text = location_text
                    texts[0].x_offset = safe_offset(left_x, frame_w - 1)
                    texts[0].y_offset = safe_offset(left_y, frame_h - 1)
                    texts[0].font_params.font_name = "Serif"
                    texts[0].font_params.font_size = 6
                    texts[0].font_params.font_color.set(1.0, 1.0, 1.0, 1.0)
                    texts[0].set_bg_clr = 0

                    # -------- Bottom Right --------
                    right_x = x + w - approx_text_width + 8
                    right_y = y + h - 16

                    texts[1].display_text = confidence_text
                    texts[1].x_offset = safe_offset(right_x, frame_w - 1)
                    texts[1].y_offset = safe_offset(right_y, frame_h - 1)
